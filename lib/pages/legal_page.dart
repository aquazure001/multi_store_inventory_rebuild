...
制定日：2026年6月13日
改定日：2026年8月3日（レジ機能・決済に関する事項を追加）
...
なお、本条に定める「料金」とは本サービス自体の利用料金を指すものであり、後記レジ機能を通じてユーザーが自らの顧客から徴収する代金とは異なるものとします。
...
第14条（レジ機能・決済に関する事項）
本サービスが提供する「レジ」機能（以下「レジ機能」といいます）は、ユーザーが自らの店舗運営において顧客との金銭の授受を記録・管理するための機能であり、当社は当該取引の当事者となるものではありません。
レジ機能を利用して顧客に交付する領収書・レシートの発行、インボイス制度に基づく登録番号の設定・管理その他税務・会計上必要な対応は、ユーザーの責任において行うものとします。
ユーザーがStripe等の決済代行サービスと連携してレジ機能を利用する場合、当該決済代行サービスの利用規約その他の定めが別途適用されるものとし、当社はこれについて一切関知しません。
レジ機能の利用によって生じた金銭上のトラブル、計算の誤り、顧客との紛争その他一切の事項について、当社は第10条の定めに従い、責任を負わないものとします。
...
制定日：2026年6月13日
改定日：2026年8月3日（レジ機能で取り扱う情報に関する記載を追加）
...
・レジ機能を利用する場合の取引情報（取引金額、購入商品明細、顧客を識別するために店舗が独自に設定する顧客コード等）
...
ユーザーがStripe等の決済代行サービスと連携してレジ機能を利用する場合、決済に関する情報は当該決済代行サービスのシステムにおいて処理されます。本サービス自体は、クレジットカード番号その他の決済手段情報を保持しない設計となっています。
