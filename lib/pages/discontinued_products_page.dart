...
class DiscontinuedProductsPage extends StatefulWidget {
  const DiscontinuedProductsPage({super.key});

  @override
  State<DiscontinuedProductsPage> createState() =>
      _DiscontinuedProductsPageState();
}

class _DiscontinuedProductsPageState extends State<DiscontinuedProductsPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance
          ...
          .doc('org_${AppSession.orgId}__products')
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('販売終了商品一覧')),
